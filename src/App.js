...
import AdPubv from "./components/AdPubv";
...
const props={ img:"https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava1-bg.webp", name:"advisor1", email:"example.com", phone:"1234567890", 
rating:"⭐ 4.6/5",description:"abcdefghijklmnopqrstuvwxyz", plans: [{ title: 'Plan 1', text: 'Some text for Plan 1.', buttonLabel: 'Button 1' },
{ title: 'Plan 2', text: 'Some text for Plan 2.', buttonLabel: 'Button 2' },
 { title: 'Plan 3', text: 'Some text for Plan 3.', buttonLabel: 'Button 3' },
 { title: 'Plan 4', text: 'Some text for Plan 4.', buttonLabel: 'Button 4' },
{ title: 'Plan 5', text: 'Some text for Plan 5.', buttonLabel: 'Button 5' }]
